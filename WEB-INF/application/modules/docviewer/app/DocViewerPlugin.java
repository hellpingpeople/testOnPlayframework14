...
public class DocViewerPlugin extends PlayPlugin {
    ...
    public void onRoutesLoaded() {
        ...
        Router.prependRoute("GET", "/@documentation/images/{firstname}", "PlayDocumentation.image");
        Router.prependRoute("GET", "/@documentation/files/{firstname}", "PlayDocumentation.file");
        Router.prependRoute("GET", "/@documentation/{docLang}/images/{firstname}", "PlayDocumentation.image");
        Router.prependRoute("GET", "/@documentation/{docLang}/files/{firstname}", "PlayDocumentation.file");
        ...
        Router.prependRoute("GET", "/@documentation/modules/{module}/images/{firstname}", "PlayDocumentation.image");
        Router.prependRoute("GET", "/@documentation/modules/{module}/files/{firstname}", "PlayDocumentation.file");
        ...
        Router.prependRoute("GET", "/@projectdocs/images/{firstname}", "ProjectDocumentation.image");
        Router.prependRoute("GET", "/@projectdocs/files/{firstname}", "ProjectDocumentation.file");
    }
